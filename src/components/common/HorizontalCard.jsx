            ...
            <>
              {isInternalRoute ? (
                <Link to={buttonLink} className="inline-block">
                  <button className="flex items-center gap-2 border-none bg-transparent text-sm font-medium text-blue-600 transition-colors hover:text-blue-800 md:text-base dark:text-teal-300 dark:hover:text-teal-200">
                    {buttonText}
